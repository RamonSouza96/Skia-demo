...
initialization
  TRegTypes.RegisterType('iPub.Android.SystemBars.TAndroid10.JInsets', TypeInfo(Android.SystemBars.TAndroid10.JInsets));
  TRegTypes.RegisterType('iPub.Android.SystemBars.TAndroid11.JWindowInsets_Type', TypeInfo(Android.SystemBars.TAndroid11.JWindowInsets_Type));
{$ELSE}
implementation
{$ENDIF}
end.
